App = {
    ...
    displayItem: async function () {
        ...
        var title = "<b>" + state + " - " + item[1][3] + "</b></br><small>[ Price: " + price + " ETH ]  [ sku: " + item[0][0] + " ]  [ upc: " + item[0][1] + " ] [ productId: " + item[1][2] + " ]";
        ...
        '<li><b>ownerID</b>: ' + item[0][2] + '</li>' + 
        '<li><b>farmerID</b>: ' + item[0][3] + '</li>' + 
        '<li><b>distributorID</b>: ' + item[1][6] + '</li>' + 
        '<li><b>retailerID:</b> ' + item[1][7] + '</li>' + 
        '<li><b>consumerID:</b> ' + item[1][8] + '</li>' + 
        // '<li>ProductID: ' + item[1][2] + '</li>' + 
        '<li><b>originFarmName:</b> ' + item[0][4] + '</li>' + 
        '<li><b>originFarmInformation:</b> ' + item[0][5] + '</li>' + 
        '<li><b>originFarmLatitude:</b> ' + item[0][6] + '</li>' + 
        '<li><b>originFarmLongitude:</b> ' + item[0][7] + '</li>'
